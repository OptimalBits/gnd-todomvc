curl( ['ginger', 'ginger/route'] , function( ginger , route ) {
  ...
  var todoList = ginger.View.extend({
    constructor : function List(collection,options){
      ...
      $('<ul id="filters">').html('<li><a class="selected" href="#/">All</a></li><li><a href="#/active">Active</a></li><li><a href="#/completed">Completed</a></li>').appendTo(self.$footer);
      self.updateCounter();
      ...
      self.$headerInput.keyup(function( e ){
        if( e.which === 13 ) {
          var description = self.$headerInput.val();
